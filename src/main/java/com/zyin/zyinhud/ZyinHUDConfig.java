...
//        	p.set(WeaponSwapper.Enabled);
        ...
        p.setComment("Set to false to scan the hotbar for swords and bows from right to left. Only matters if you have multiple swords/bows in your hotbar.");
        if(loadSettings)
        ...
        */
        ...
        p.setComment("Enable/Disable showing a timer counting down to when the animal is ready to breed again.");
        if(loadSettings)
        ...
        */
        ...
        p.setComment("Enable/Disable showing a timer that tells you how long until a horse can breed again.");
        if(loadSettings)
        ...
        p.setComment("Enable/Disable showing a timer that tells you how long until a villager can breed again.");
        if(loadSettings)
        ...
        p.setComment("Enable/Disable showing a timer that tells you how long until a cow can breed again.");
        if(loadSettings)
        ...
        p.setComment("Enable/Disable showing a timer that tells you how long until a sheep can breed again.");
        if(loadSettings)
        ...
        p.setComment("Enable/Disable showing a timer that tells you how long until a pig can breed again.");
        if(loadSettings)
        ...
        p.setComment("Enable/Disable showing a timer that tells you how long until a chicken can breed again.");
        if(loadSettings)
        ...
        p.setComment("Enable/Disable showing a timer that tells you how long until a wolf can breed again.");
        if(loadSettings)
        ...
        p.setComment("Enable/Disable showing a timer that tells you how long until an ocelot can breed again.");
        if(loadSettings)
